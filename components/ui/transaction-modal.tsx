...
export function TransactionModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className={cn('border-gray-800 bg-gray-900/95 backdrop-blur-sm text-white max-h-[90vh] overflow-y-auto overscroll-contain z-[9999]', getBorderColor())}>
        <DialogHeader>
