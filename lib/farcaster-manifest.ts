 ...
 * Keep in sync with public/.well-known/farcaster.json
 */
export const FARCASTER_MANIFEST = {
  accountAssociation: {
    header:
      'eyJmaWQiOjM3OTUzMywidHlwZSI6ImN1c3RvZHkiLCJrZXkiOiIweGM5NjBFNTEzMjFiNUU3YTk3MDM5Yjk3ZjU3MTdjM2RCZDJiODdmODAifQ',
    payload: 'eyJkb21haW4iOiJtaW5pYXBwLmRlY2xlYW51cC5uZXQifQ',
    signature:
      '7NVO5bQDmhbkB+HujppHIqS5t8buSzHdFGdROFnZl8gscUFTybMd5zjXdVMVklFCqvGETUExHf0ADcunkIKi3hs=',
  },
  baseBuilder: {
  ...
  miniapp: {
    ...
    description:
      'Join the global cleanup movement. Submit cleanups, earn Impact Products, and make a real difference.',
    screenshotUrls: [
