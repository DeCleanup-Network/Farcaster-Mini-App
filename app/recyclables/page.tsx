...
export default function RecyclablesPage() {
  ...
  const [kilogramsRecycled, setKilogramsRecycled] = useState<string>('')
    ...
    return (
      <div className="min-h-screen bg-black px-4 py-8">
        <div className="mx-auto max-w-md rounded-lg border border-gray-800 bg-gray-900 p-6 text-center">
          ...
          <p className="mb-6 text-gray-400">
            Your recyclables submission has been received. After verification, you will receive 5 cRECY tokens.
          </p>
      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mb-4 text-sm text-gray-400">
            Submit proof of separated recyclables to earn 5 cRECY tokens per submission.
          </p>
          <div className="mb-4 rounded-lg border border-gray-800 bg-gray-900 p-3">
            <p className="text-xs text-gray-300">
              <span className="font-medium text-brand-green">Reserve:</span> 5,000 cRECY tokens available
            </p>
            <p className="mt-1 text-xs text-gray-400">
              {remainingReserve.toFixed(0)} cRECY remaining
            </p>
          </div>
        ...
        <div className="mb-6">
          <label className="mb-2 block text-sm font-medium text-gray-300">
            How many kgs were recycled? <span className="text-gray-500">(optional)</span>
          </label>
          <input
            type="number"
            min="0"
            step="0.1"
            value={kilogramsRecycled}
            onChange={(e) => setKilogramsRecycled(e.target.value)}
            className="w-full rounded-lg border border-gray-700 bg-gray-900 px-3 py-2 text-white placeholder-gray-500"
            placeholder="e.g., 5.5"
          />
          <p className="mt-1 text-xs text-gray-500">
            Enter the total weight of recyclables in kilograms
          </p>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-gray-500">
          After verification, you will receive 5 cRECY tokens. Reserve: 5,000 cRECY total, {remainingReserve.toFixed(0)} cRECY remaining.
        </p>
      </div>
    </div>
  )
